...
import { CateTitle, Category, CloseBtn, Container, DivArea, Infra, MapWrap, MenuBtn, Search, SideBar, SideWrap, Space, WaitBox } from "@/styles/map1.styles";
...
const map = () => {
    ...
    const infraBtnClick = (cnt, type) => {
        ...
        if (!cnt) {
            ...
            typeBtn[type].current.style.boxShadow = "1px 2px 0px 1px rgba(165, 165, 165, 0.09), 2px 3px 0px 0px rgb(26 26 26 / 19%) inset";
